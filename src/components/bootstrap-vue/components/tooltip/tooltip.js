...
export const BTooltip = /*#__PURE__*/ extend({
    ...
    beforeUnmount() {
        ...
        emitter.off(EVENT_NAME_OPEN, this.doOpen);
        emitter.off(EVENT_NAME_CLOSE, this.doClose);
        emitter.off(EVENT_NAME_DISABLE, this.doDisable);
        emitter.off(EVENT_NAME_ENABLE, this.doEnable);
    ...
    mounted() {
        ...
        this.$nextTick(() => {
            ...
            emitter.on(EVENT_NAME_OPEN, this.doOpen);
            // Listen to close signals from others
            emitter.on(EVENT_NAME_CLOSE, this.doClose);
            // Listen to disable signals from others
            emitter.on(EVENT_NAME_DISABLE, this.doDisable);
            // Listen to enable signals from others
            emitter.on(EVENT_NAME_ENABLE, this.doEnable);
