    ...
    methods: {
        ...
        renderTbodyRowCell(field, colIndex, item, rowIndex) {
            ...
            if (stickyColumn) {
                ...
                data.attrs['data-label'] =
                    isStacked && !isUndefinedOrNull(label) ? toString(label) : null;
        ...
        renderTbodyRow(item, rowIndex) {
            ...
            const hasRowClickHandler =
                this.$listeners[EVENT_NAME_ROW_CLICKED] || hasSelectableRowClick;
            ...
            const userTrClasses = isFunction(tbodyTrClass)
                ? tbodyTrClass(item, 'row')
                : tbodyTrClass;
